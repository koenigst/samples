...
fn main() {
    ...
    let day06_input = read_lines("src/day06/input.txt");
    println!("Day 06g: {}", day06::compute_solution_gold(&day06_input));
    println!("Day 06s: {}", day06::compute_solution_silver(&day06_input));
}
